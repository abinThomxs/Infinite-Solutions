...
const Banner = (props: Props) => {
  ...
  return (
    <div id='shad1' className='w-full flex justify-center items-center m-16 bg-blue-100 '>
      <div id='shad' className='w-6/12 flex justify-center items-center p-8 mt-16  mb-16 bg-white '>
